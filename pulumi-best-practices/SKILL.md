...
*Adapted from [pulumi/agent-skills](https://github.com/pulumi/agent-skills) (Apache 2.0 License, Copyright Pulumi Corporation) with Pulumi permission. Modified to fit this repository's style and conventions.*
